...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`gmall0925` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `order_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单表 订单表';
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_user`( create_time_string VARCHAR(200),max_num INT  )
BEGIN  
 DECLARE v_create_time DATETIME DEFAULT NULL;
 DECLARE i INT DEFAULT 0;
